...
export class PublisherController {
  ...
  async findAll(
    ...
    return {
      data: await this.publisherService.findAll(
        findPublisher,
        reqUser.libraryId,
      ),
  ...
  async findOne(@Req() req: Request, @Param('id') id: string) {
    ...
    const publisher: Publisher = await this.publisherService.findOne(
      +id,
      reqUser.libraryId,
    );
    if (null == publisher)
  ...
  async remove(@Req() req: Request, @Param('id') id: string) {
    ...
    const deletedPublisher = await this.publisherService.remove(
      +id,
      reqUser.libraryId,
    );
